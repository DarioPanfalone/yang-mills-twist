...
void readinput(char *in_file, GParam *param)
    ...
    if(input==NULL)
      ...
      while(end==1)   // slide the file
           ...
           if(strncmp(str, "size", 4)==0)
	         ...
	         // MONOPOLES file
           ...
           else if(strncmp(str, "tube_file", 9) == 0)
                  {
                  err=fscanf(input, "%s", temp_str);
                  if(err!=1)
                    {
                  ...
                  strcpy(param->d_tube_file, temp_str);
                  }
           else if(strncmp(str, "poly_file", 9) == 0)
                  {
                  err=fscanf(input, "%s", temp_str);
                  if(err!=1)
                    {
                  ...
                  strcpy(param->d_poly_file, temp_str);
                  }
           else if(strncmp(str, "padj_file", 9) == 0)
                  {
                  err=fscanf(input, "%s", temp_str);
                  if(err!=1)
                    {
                  ...
                  strcpy(param->d_padj_file, temp_str);
                  }
           else if(strncmp(str, "plaq_file", 9) == 0)
                  {
                  err=fscanf(input, "%s", temp_str);
                  if(err!=1)
                    {
                  ...
                  strcpy(param->d_plaq_file, temp_str);
                  }
           else if(strncmp(str, "poly_dist_min", 13)==0)
                  {
                  err = fscanf(input, "%d", &temp_i);
                  if (err != 1)
                    {
                  ...
                  param->d_poly_dist_min = temp_i;
                  }
           else if(strncmp(str, "poly_dist_max", 13)==0)
                  {
                  err = fscanf(input, "%d", &temp_i);
                  if (err != 1)
                    {
          ...
          else if(strncmp(str, "triangle_base", 13)==0)
                  {
                  err=fscanf(input, "%d", &temp_i);
                  if(err!=1)
                    {
                  ...
                  param->d_triangle_base=temp_i;
                  }
          else if(strncmp(str, "triangle_hight", 14)==0)
                  {
                  err=fscanf(input, "%d", &temp_i);
                  if(err!=1)
                    {
...
// print simulation parameters Twist
...
// print simulation parameters
void print_parameters_tube_disc_highT(GParam * param, time_t time_start, time_t time_end)
    {
    FILE *fp;
    int i;
    double diff_sec;
    ...
    fp=fopen(param->d_log_file, "w");
    fprintf(fp, "+---------------------------------------------------+\n");
    fprintf(fp, "| Simulation details for yang_mills_tube_disc_highT |\n");
    fprintf(fp, "+---------------------------------------------------+\n\n");
