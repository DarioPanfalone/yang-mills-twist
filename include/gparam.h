...
typedef struct GParam {
  ...
  // for flux tube measure
  int d_poly_dist_min;
  int d_poly_dist_max;
  int d_poly_dist_step;

  // for the barion measures
  int d_triangle_base;
  int d_triangle_hight;
  ...
  char d_tube_file[STD_STRING_LENGTH];
  char d_plaq_file[STD_STRING_LENGTH];
  char d_poly_file[STD_STRING_LENGTH];
  char d_padj_file[STD_STRING_LENGTH];
